...
public class TestUtil {
    ...
    static Unit getMockUnit() {
        return new Unit() {
            ...
            @Override public boolean getWary() {
                return false;
            }
            ...
            @Override public boolean getEntrench() {
                return false;
            }
            ...
            @Override public Unit copy(UnitOwner newOwner, GameState newState) {
                return null;
            }
        };
    }
    ...
    static GameState getMockGameState() {
        return new GameState() {
            ...
            @Override public SaveInstance export() {
                return null;
            }
            ...
            @Override public int getNumberTurns() {
                return 0;
            }
            ...
            @Override public void move(Unit unit, Direction direction) {

            }

            @Override public void move(Unit unit, MapLocation mapLocation) {
            ...
            @Override public List<MapLocation> getTilesInRange(MapLocation location, int range)
            {
                return null;
            ...
            @Override public List<Unit> getUnitsInRange(MapLocation location, int range) {
                return null;
            }            @Override public UnitOwner getThisInstancePlayer() {
                return null;
            }

            @Override public List<Unit> getUnitsInAttackRange(Unit unit) {
                return null;
            }            @Override public GameCollections getWorld() {
                return null;
            }

            @Override public List<MapLocation> getTilesInMoveRange(Unit unit) {
                return null;
